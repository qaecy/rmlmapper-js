...
async function readInputFiles(
  ...
  return await inputFileNames.reduce(
    async (
...
describe('Parsing', (): void => {
  describe('with turtle mappings', (): void => {
    ...
    it('Array Value mapping.', async (): Promise<void> => {
      ...
      assert.equal(result['https://schema.org/name'], 'Tom A.');
      assert.equal(
        (result['http://example.com/favorite-numbers'] as NodeObject[]).length,
        3
      );
      assert.equal(
        (result['http://example.com/favorite-numbers'] as NodeObject[])[0][
          '@value'
        ],
        '3'
      );
      ...
      assert.equal(
        (result['http://example.com/favorite-numbers'] as NodeObject[])[1][
          '@value'
        ],
        '33'
      );
      ...
      assert.equal(
        (result['http://example.com/favorite-numbers'] as NodeObject[])[2][
          '@value'
        ],
        '13'
      );
    ...
    it('Live mapping.', async (): Promise<void> => {
      ...
      const result = (await parseTurtle(mapFile, inputFiles, {}).catch(
        (err: any): void => {
          console.log(err);
        }
      )) as NodeObject[];
      ...
      assert.equal(
        (result[5]['http://mytestprefix.org/requires'] as NodeObject).length,
        2
      );
      assert.equal(
        (result[6]['http://mytestprefix.org/requires'] as NodeObject)['@id'],
        '_:http%3A%2F%2Fexample.test%2F%23REQmapping_3'
      );
    });

    it('Live mapping with condition for ignoring subjects.', async (): Promise<void> => {
...
@prefix qcy-f: <https://dev.qaecy.com/functions#>.
@prefix qcy-e: <https://dev.qaecy.com/enum#>.
@prefix qcy: <https://dev.qaecy.com/ont#>.
@prefix fzag: <https://dev.qaecy.com/c/fzag/enum#>.
@prefix ex: <http://example.com/>.
@prefix grel: <http://users.ugent.be/~bjdmeest/function/grel.ttl#>.
@prefix idlab-fn: <https://w3id.org/imec/idlab/function#>.

<http://mapping.example.com/rules_000> a <http://rdfs.org/ns/void#Dataset>;
    <http://rdfs.org/ns/void#exampleResource> <http://mapping.example.com/map_roomType_000>.
<http://mapping.example.com/map_roomType_000> <http://semweb.mmlab.be/ns/rml#logicalSource> <http://mapping.example.com/source_000>.
...
<http://mapping.example.com/map_roomType_000> a rr:TriplesMap;
    rdfs:label "roomType".
<http://mapping.example.com/s_000> a rr:SubjectMap.
<http://mapping.example.com/map_roomType_000> rr:subjectMap <http://mapping.example.com/s_000>.
<http://mapping.example.com/s_000> a fnml:FunctionTermMap;
    rr:termType rr:IRI;
    fnml:functionValue <http://mapping.example.com/fn_000>.
<http://mapping.example.com/fn_000> <http://semweb.mmlab.be/ns/rml#logicalSource> <http://mapping.example.com/source_000>;
    rr:predicateObjectMap <http://mapping.example.com/pomexec_000>.
<http://mapping.example.com/pomexec_000> rr:predicateMap <http://mapping.example.com/pmexec_000>.
<http://mapping.example.com/pmexec_000> rr:constant fno:executes.
<http://mapping.example.com/pomexec_000> rr:objectMap <http://mapping.example.com/omexec_000>.
<http://mapping.example.com/omexec_000> rr:constant "https://w3id.org/imec/idlab/function#trueCondition";
    rr:termType rr:IRI.
<http://mapping.example.com/fn_000> rr:predicateObjectMap <http://mapping.example.com/pom_000>.
...
<http://mapping.example.com/pom_000> rr:objectMap <http://mapping.example.com/om_000>.
<http://mapping.example.com/om_000> a rr:ObjectMap, fnml:FunctionTermMap;
    fnml:functionValue <http://mapping.example.com/fn_001>.
<http://mapping.example.com/fn_001> <http://semweb.mmlab.be/ns/rml#logicalSource> <http://mapping.example.com/source_000>;
    rr:predicateObjectMap <http://mapping.example.com/pomexec_001>.
<http://mapping.example.com/pomexec_001> rr:predicateMap <http://mapping.example.com/pmexec_001>.
<http://mapping.example.com/pmexec_001> rr:constant fno:executes.
<http://mapping.example.com/pomexec_001> rr:objectMap <http://mapping.example.com/omexec_001>.
<http://mapping.example.com/omexec_001> rr:constant "https://w3id.org/imec/idlab/function#notEqual";
    rr:termType rr:IRI.
<http://mapping.example.com/fn_001> rr:predicateObjectMap <http://mapping.example.com/pom_001>.
...
<http://mapping.example.com/pom_001> rr:objectMap <http://mapping.example.com/om_001>.
<http://mapping.example.com/om_001> a rr:ObjectMap;
    <http://semweb.mmlab.be/ns/rml#reference> "businessAreaNo";
    rr:termType rr:Literal.
<http://mapping.example.com/fn_001> rr:predicateObjectMap <http://mapping.example.com/pom_002>.
...
<http://mapping.example.com/pom_002> rr:objectMap <http://mapping.example.com/om_002>.
<http://mapping.example.com/om_002> a rr:ObjectMap;
    rr:constant "";
    rr:termType rr:Literal.
<http://mapping.example.com/fn_000> rr:predicateObjectMap <http://mapping.example.com/pom_003>.
...
<http://mapping.example.com/pom_003> rr:objectMap <http://mapping.example.com/om_003>.
<http://mapping.example.com/om_003> a rr:ObjectMap;
    rr:template "http://example.com/{TypeOfUseNo}";
    rr:termType rr:IRI.
<http://mapping.example.com/pom_004> a rr:PredicateObjectMap.
<http://mapping.example.com/map_roomType_000> rr:predicateObjectMap <http://mapping.example.com/pom_004>.
<http://mapping.example.com/pm_004> a rr:PredicateMap.
<http://mapping.example.com/pom_004> rr:predicateMap <http://mapping.example.com/pm_004>.
<http://mapping.example.com/pm_004> rr:constant rdf:type.
<http://mapping.example.com/pom_004> rr:objectMap <http://mapping.example.com/om_004>.
<http://mapping.example.com/om_004> a rr:ObjectMap;
    rr:constant qcy:CanonicalEntity;
    rr:termType rr:IRI.
<http://mapping.example.com/pom_005> a rr:PredicateObjectMap.
<http://mapping.example.com/map_roomType_000> rr:predicateObjectMap <http://mapping.example.com/pom_005>.
<http://mapping.example.com/pm_005> a rr:PredicateMap.
<http://mapping.example.com/pom_005> rr:predicateMap <http://mapping.example.com/pm_005>.
<http://mapping.example.com/pm_005> rr:constant qcy:value.
<http://mapping.example.com/pom_005> rr:objectMap <http://mapping.example.com/om_005>.
<http://mapping.example.com/om_005> a rr:ObjectMap;
    <http://semweb.mmlab.be/ns/rml#reference> "TypeOfUseNo";
    rr:termType rr:Literal.`;
      ...
      const resultTTL = (await parseTurtle(
        mapFile,
        { 'data.json': JSON.stringify(jsonObj) },
        { toRDF: true }
      ).catch((err: any): void => {
      ...
      assert.equal(resultJSONLD.length, 3);
      assert.equal(resultJSONLD[0]['@id'], 'http://example.com/0.0.0');
      assert.equal(resultJSONLD[0]['https://dev.qaecy.com/ont#value'], '0.0.0');
      assert.equal(
        resultJSONLD[1]['@type'],
        'https://dev.qaecy.com/ont#CanonicalEntity'
      );
      assert.equal(resultTTL.includes('<http://example.com/0.0.0>'), true);
      assert.equal(resultTTL.includes('<http://example.com/1.1.4>'), true);
      assert.equal(resultTTL.includes('<http://example.com/1.1.5>'), true);
    });
    ...
    it('Nested mapping.', async (): Promise<void> => {
      ...
      assert.equal(
        (result[0]['http://mytestprefix.org/likesSports'] as NodeObject)['@id'],
        '_:http%3A%2F%2Fexample.test%2F%23SPORTSmapping_1'
      );
      assert.equal(
        (result[1]['http://mytestprefix.org/name'] as string[])[1],
        'Football'
      );
    });
    ...
    it('Nested mapping with array of input.', async (): Promise<void> => {
      ...
      assert.equal(result[1]['https://schema.org/name'], 'Tom B.');
      assert.equal(
        (result[1]['http://mytestprefix.org/likesSports'] as NodeObject)['@id'],
        '_:http%3A%2F%2Fexample.test%2F%23SPORTSmapping_2'
      );
      assert.equal(Object.keys(result).length, 4);
    });
    ...
    it('Async function mapping.', async (): Promise<void> => {
      const options = {
        functions: {
          'http://users.ugent.be/~bjdmeest/function/grel.ttl#asyncFunc':
            async function createDescription(data: any[]): Promise<string> {
      ...
      assert.equal(
        result[1]['http://mytestprefix.org/description'],
        testString
      );
    });
    ...
    it('Non Array Predicate Object Mapping.', async (): Promise<void> => {
      const options = {
        functions: {
          'https://w3id.org/imec/idlab/function#random'(): string {
            return '42';
          },
        },
      };
      ...
      assert.equal(
        Object.keys(result[0]).includes('http://example.com/uuid'),
        true
      );
    ...
    it('Triple nested mapping.', async (): Promise<void> => {
      ...
      assert.equal(
        Object.keys(
          result[0]['http://mytestprefix.org/likesSports'] as NodeObject
        ).length,
        1
      );
      assert.equal(
        Object.keys(
          result[1]['http://mytestprefix.org/likesSports'] as NodeObject
        ).length,
        1
      );
    ...
    it('Double-nested mapping XML.', async (): Promise<void> => {
      ...
      assert.equal(
        (likesSport['http://mytestprefix.org/requires'] as ReferenceNodeObject)[
          '@id'
        ],
        '_:http%3A%2F%2Fexample.test%2F%23REQmapping_1'
      );
    ...
    it('template mapping XML.', async (): Promise<void> => {
      ...
      assert.equal(
        (result[0]['http://mytestprefix.org/name'] as NodeObject[])[0]['@id'],
        'http://foo.com/1'
      );
    });
    ...
    it('datatype test.', async (): Promise<void> => {
      ...
      assert.equal(
        (result[0]['http://mytestprefix.org/name'] as NodeObject)['@value'],
        'Tom A.'
      );
      assert.equal(
        (result[0]['http://mytestprefix.org/name'] as NodeObject)['@type'],
        'http://www.w3.org/2001/XMLSchema#string'
      );
      assert.equal(
        (result[0]['http://mytestprefix.org/age'] as NodeObject)['@value'],
        '15'
      );
      assert.equal(
        (result[0]['http://mytestprefix.org/age'] as NodeObject)['@type'],
        'http://www.w3.org/2001/XMLSchema#integer'
      );
      assert.equal(
        (result[0]['http://mytestprefix.org/url'] as NodeObject)['@value'],
        'http://example.com/foo'
      );
      assert.equal(
        (result[0]['http://mytestprefix.org/url'] as NodeObject)['@type'],
    ...
    it('doubleJoinCondition.', async (): Promise<void> => {
      const result = await parseFileTurtle(
        ...
        [
          './test/assets/doubleJoinCondition/data.csv',
          './test/assets/doubleJoinCondition/data2.csv',
        ],
      ...
      assert.deepEqual(result, [
        {
          ...
          'http://www.example.com/relation': {
            '@id': 'http://second-example.com/1',
          },
        },
        {
    ...
    it('constant Iri.', async (): Promise<void> => {
      ...
      assert.deepEqual(result[0]['http://mytestprefix.org/url'], {
        '@id': 'http://ex.com',
      });
    ...
    it('language.', async (): Promise<void> => {
      ...
      assert.deepStrictEqual(
        (result[0]['https://schema.org/language'] as NodeObject[])[0],
        { '@value': 'John', '@language': 'en' }
      );
      assert.deepStrictEqual(
        (result[0]['https://schema.org/language'] as NodeObject[])[1],
        { '@value': 'John', '@language': 'de' }
      );
      assert.deepStrictEqual(
        (result[0]['https://schema.org/language'] as NodeObject[])[2],
        { '@value': 'John', '@language': 'de-DE' }
      );
    });
    ...
    it('IRI termType with Function Map.', async (): Promise<void> => {
      ...
      assert.equal(
        (result[0]['http://example.com/namesake'] as ReferenceNodeObject)[
          '@id'
        ],
        'http://example.com/John'
      );
      assert.equal(
        (result[1]['http://example.com/namesake'] as ReferenceNodeObject)[
          '@id'
        ],
    ...
    it('iriReference.', async (): Promise<void> => {
      ...
      assert.deepEqual(result[0]['https://schema.org/reference'], {
        '@id': 'https://example.com/john',
      });
      assert.deepEqual(result[0]['https://schema.org/constant'], {
        '@id': 'https://example.com/john',
      });
      assert.deepEqual(result[0]['https://schema.org/template'], {
        '@id': 'https://example.com/john',
      });
    });
          ...
          'http://example.com/sum_array_of_number_objects'(data: any): string {
            return data['http://example.com/input']
              .map((input: Record<string, NodeObject>): number =>
                Number.parseInt(
                  input['http://example.com/number']['@value'] as string,
                  10
                )
              )
